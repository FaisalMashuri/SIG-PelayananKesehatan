...
router.route("/kelurahan/kecamatan").get(getKelurahanDariKecamatan);
router.route("/pelayanan/kelurahan").post(getPelyananDariKelurahan);
router.route("/kecamatan/:id").get(getDetailKecamatan);
router.route("/pelayanan/jenis-pelayanan").get(getPelayananByTypePelayanan);
router.route("/pelayanan/kecamatan").post(getPelayananDariKecamatan);
router
